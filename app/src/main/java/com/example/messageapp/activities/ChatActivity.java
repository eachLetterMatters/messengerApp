...
//                    user.id = queryDocumentSnapshot.getId();
            ...
            Toast.makeText(getApplicationContext(), "EventListener" + String.valueOf(chatMessages.size()), Toast.LENGTH_SHORT).show();
            if(count == 0) {
    ...
    protected Bitmap getBitmapFromEncodedString(String encodedImage){
